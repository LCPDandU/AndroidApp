...
public class CompactCalendarTab extends Fragment {
   // TextView tvNotificationList;
    ...
    static ArrayList<EventObjects> events = MainActivity.Elist;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // requestQueue = Volley.newRequestQueue(getContext());  // This setups up a new request queue which we will need to make HTTP requests.
